...
-- Joining retirement_info and dept_emp tables (Shortened w/ aliases)
SELECT ri.emp_no,
    ri.first_name,
	ri.last_name,
    de.to_date
...
-- Joining departments and dept_manager tables (Shortened w/ aliases)
SELECT d.dept_name,
     dm.emp_no,
     dm.from_date,
     dm.to_date
